...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GetStampd" },
      { name: "description", content: "Event Passport Platform" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "GetStampd" },
      { property: "og:description", content: "Event Passport Platform" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "GetStampd" },
      { name: "twitter:description", content: "Event Passport Platform" },
