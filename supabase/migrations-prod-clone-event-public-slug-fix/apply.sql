...
--   null value in column "public_slug" of relation "events" violates not-null
-- Generate a unique public_slug for the clone instead of inserting NULL.
...
begin
  ...
  -- Public slug (globally unique). Start from the same base and add a random
  -- suffix to avoid collisions with other agencies' events.
