-- 02_extend_get_public_event_by_domain_hero_overlay.sql
-- DRAFT ONLY. Do not execute against production without approval.
--
-- Run AFTER 01_event_branding_hero_overlay.sql.
--
-- Purpose:
--   Extend public.get_public_event_by_domain(_hostname) so public
--   passport pages can read the new hero_overlay_color and
--   hero_overlay_opacity columns.
--
...
as $$
  ...
  select
    ...
    b.hero_overlay_color              as hero_overlay_color,
    b.hero_overlay_opacity            as hero_overlay_opacity
  from resolved r
