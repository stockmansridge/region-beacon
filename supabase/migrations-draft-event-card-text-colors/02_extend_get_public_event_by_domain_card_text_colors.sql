-- 02_extend_get_public_event_by_domain_card_text_colors.sql
-- DRAFT ONLY. Do not execute against production without approval.
--
-- Run AFTER 01_event_branding_card_text_colors.sql AND after the
-- previous text-colour migration:
--   supabase/migrations-draft-event-text-colors/02_extend_get_public_event_by_domain_text_colors.sql
--
-- Purpose:
--   Extend public.get_public_event_by_domain(_hostname) to surface the
--   new card-surface text columns so public passport pages can read
